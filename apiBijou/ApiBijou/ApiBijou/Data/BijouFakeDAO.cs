...
namespace API_SAE.Data
{
    ...
    public class BijouFakeDAO : IBijouDAO
    {
            ...
            this.bijoux = new Dictionary<int, Bijou>
        {
            ...
            { 3, new Bijou { Id = 3, Name = "Bague, collection 'Élégance'", Description = "Description du bijou 4", Price = 78, Type="Bagues", DossierPhoto="Bague 62"} },
            ...
            { 10, new Bijou { Id = 10, Name = "Bague, collection 'Géométrie abstraite'", Description = "Description du bijou 11", Price = 56, Type="Bagues", DossierPhoto="Bague 71" } },
            { 11, new Bijou { Id = 11, Name = "Bague, collection 'Élégance'", Description = "Description du bijou 12", Price = 56, Type="Bagues", DossierPhoto="Bague 64"  } }
        };
